...
// -- Splash Screen Text
const String tAppName = "TAXITEST";
const String tAppTagLine = "Texto de prueba";

// -- Welcome Screen text

const String tWelcomeTitle = "TAXITEST";
const String tWelcomeSubTitle = "Eslogan acá";
...
const String tSignUpSubTitle = "Crea tu cuenta para iniciar.";
const String tAlreadyHaveAnAccount = "Already have an Account? ";

// -- Forget Password Text
const String tForgetPasswordTitle = "Forget Password";
